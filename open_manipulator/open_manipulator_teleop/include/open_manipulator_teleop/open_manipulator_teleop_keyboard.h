...
#define DELTA 0.02 // translation in x,y and z axis
#define JOINT_DELTA 0.0872 // amount of rotation in radian (5 degrees)
#define PATH_TIME 1 // execution time period (2.0)
