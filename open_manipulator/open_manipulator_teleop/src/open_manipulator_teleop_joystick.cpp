...
void OpenManipulatorTeleop::joyCallback(const sensor_msgs::Joy::ConstPtr &msg)
{
  ...
  if(msg->axes.at(1) >= 0.9) setGoal("j2c");
  else if(msg->axes.at(1) <= -0.9) setGoal("j2a");
  else if(msg->axes.at(0) >=  0.9) setGoal("j1c");
  else if(msg->axes.at(0) <= -0.9) setGoal("j1a");
  else if(msg->axes.at(3) >=  0.9) setGoal("j3c");
  else if(msg->axes.at(3) <= -0.9) setGoal("j3a");
  else if(msg->buttons.at(3) == 1) setGoal("j4c");
  else if(msg->buttons.at(0) == 1) setGoal("j4a");
  else if(msg->buttons.at(5) == 1) setGoal("home");
  else if(msg->buttons.at(4) == 1) setGoal("init");
...
// added the following lines 103 to 115
