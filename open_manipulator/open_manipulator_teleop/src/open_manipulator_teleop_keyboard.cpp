...
void OpenManipulatorTeleop::setGoal(char ch)
{
  ...
  if(ch == 'd' || ch == 'D')
  {
    printf("input : d \tincrease(++) x axis in task space\n");
    goalPose.at(0) = DELTA;
    setTaskSpacePathFromPresentPositionOnly(goalPose, PATH_TIME);
  }
  else if(ch == 'a' || ch == 'A')
  {
    printf("input : a \tdecrease(--) x axis in task space\n");
    goalPose.at(0) = -DELTA;
    setTaskSpacePathFromPresentPositionOnly(goalPose, PATH_TIME);
  }
  else if(ch == 'w' || ch == 'W')
  {
    printf("input : w \tincrease(++) y axis in task space\n");
    goalPose.at(1) = DELTA;
    setTaskSpacePathFromPresentPositionOnly(goalPose, PATH_TIME);
  }
  else if(ch == 's' || ch == 'S')
  {
    printf("input : s \tdecrease(--) y axis in task space\n");
    goalPose.at(1) = -DELTA;
    setTaskSpacePathFromPresentPositionOnly(goalPose, PATH_TIME);
  }
  else if(ch == 'z' || ch == 'Z')
...
//    printf("%lf", PATH_TIME);
  ...
  else if(ch == '2')
  {
    ...
    joint_name.push_back("joint2"); joint_angle.push_back(0.249); /*60 degrees*/
    joint_name.push_back("joint3"); joint_angle.push_back(0.140); /*20 degrees*/
    joint_name.push_back("joint4"); joint_angle.push_back(0.837); /*40 degrees*/
  ...
  else if(ch == '1')
  {
    ...
    std::vector<double> joint_angle;
    double path_time = 2.0;
    joint_name.push_back("joint1"); joint_angle.push_back(1.57); /* in radians (90 degrees) */
