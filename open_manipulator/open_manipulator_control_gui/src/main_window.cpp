...
// double MainWindow::degree_to_radians(double D){
...
void MainWindow::on_btn_send_joint_angle_clicked(void)
{
  ...
  joint_name.push_back("joint1"); joint_angle.push_back((pi/180)*(ui.doubleSpinBox_j1->value()));
  joint_name.push_back("joint2"); joint_angle.push_back((pi/180)*(ui.doubleSpinBox_j2->value()));
  joint_name.push_back("joint3"); joint_angle.push_back((pi/180)*(ui.doubleSpinBox_j3->value()));
  joint_name.push_back("joint4"); joint_angle.push_back((pi/180)*(ui.doubleSpinBox_j4->value()));
  ...
  // cout << type(ui.doubleSpinBox_j1->value()) << endl
  printf("%f\n",ui.doubleSpinBox_j1->value());
  // printf("%s\n", );(ui.doubleSpinBox_j2->value());
  // writeLog(ui.doubleSpinBox_j3->value());
  // writeLog(ui.doubleSpinBox_j4->value());
  printf("%f\n",ui.doubleSpinBox_j2->value());
